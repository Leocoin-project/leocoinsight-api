...
var genesisTXID = 'e2a0a4f5cb59f87619dbf9e88e341d79c1fef7a82245df0760559a7371822451';
var CONCURRENCY = 10;
...
var bitcore = require('LEOcoincore'),
...
var encodedData = require('soop').load('LEOcoincore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('LEOcoincore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('LEOcoincore/lib/Address', {
